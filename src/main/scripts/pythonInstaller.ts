...
const pythonInstallerRun = (url: string, dir: string, terminal: "powershell" | "shell") => {
  ...
  const command = terminal === "powershell" ? `
  powershell -Command "
...
async function pythonInstaller(context: Context) {
  try {
    ...
    const pythonInstallerPaths = {
      win32: 'https://github.com/dynamic-computer/python-build-standalone/releases/download/1.0.0/cpython-3.11.11+2050106-x86-64-pc-windows-msvc-shared-install_only.zip',
      darwin: 'https://github.com/dynamic-computer/python-build-standalone/releases/download/1.0.0/cpython-3.11.11+20250106-x86_64-apple-darwin-install_only.tar.gz',
      linux: 'https://github.com/dynamic-computer/python-build-standalone/releases/download/1.0.0/cpython-3.11.11+20250106-x86_64-unknown-linux-gnu-install_only.tar.gz',
    }
