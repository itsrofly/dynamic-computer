    ...
    return (
        <>
            <div className="d-flex justify-content-around mt-5 mb-5 text-white">
                <div>
                    <a role="button" target="_blank" href={website} className="text-white  link-underline link-underline-opacity-0">
                ...
                <a role="button" className='text-white icon-link icon-link-hover'
                    ...
                    <svg className="bi fs-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#e8eaed">
