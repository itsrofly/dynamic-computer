...
function ProfileModal(): JSX.Element {
    ...
    const profile =
        localStorage.getItem("profile") ?
            JSON.parse(localStorage.getItem("profile") as string) as Profile : null;
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="profileModalLabel">{profile ? "Profile" : "Sign In"}</h1>
                            ...
                            {!profile ?
                                ...
                                <>
                                    <div className="w-100 d-flex justify-content-center">
                                        <a role="button" className="d-flex justify-content-center btn btn-outline-dark icon-link" style={{ width: "300px" }}
                                            onClick={SignIn}>
                                ...
                                <>
                                    ...
                                    <div className="w-100 d-flex justify-content-center gap-3">
                                        <a role="button" className="btn btn-outline-primary" target="_blank" href={website + '/Profile'}>
                                            Manage
                                        </a>
